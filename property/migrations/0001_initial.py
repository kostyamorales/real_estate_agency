    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address',
                 models.TextField(help_text='ул. Подольских курсантов д.5 кв.4', verbose_name='Адрес квартиры')),
                ('floor', models.CharField(help_text='Первый этаж, последний этаж, пятый этаж', max_length=3,
                                           verbose_name='Этаж')),
                ('rooms_number', models.IntegerField(db_index=True, verbose_name='Количество комнат в квартире')),
                ('living_area',
                 models.IntegerField(db_index=True, null=True, verbose_name='количество жилых кв.метров')),
                ...
                ('construction_year',
                 models.IntegerField(db_index=True, null=True, verbose_name='Год постройки здания')),
            ],
        ),
    ]
